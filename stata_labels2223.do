...
label variable gtcbsa "Specific Metropolitan CBSA code"
...
label variable prsjmj "Single/multiple jobholder recode"
...
label variable pternh1c "What is your hourly rate of pay on this job, excluding overtime pay, tips or commission?"
label variable pternh2 "(Excluding overtime pay, tips and commissions) what is your hourly rate of pay on your (main/this) job?"
label variable pternh1o "Out variable for hourly rate of pay"
label variable pternhly "Recode for hourly rate"
label variable pthr "Hourly pay - top code"
label variable peernhro "Usual hours"
label variable pternwa "Weekly earnings recode"
label variable ptwk "Weekly earnings - top code"
label variable ptern "Calculated weekly overtime amount"
label variable ptern2 "Calculated weekly overtime amount"
...
label variable ptio1ocd "Occupation code for primary job."
label variable peio2icd "Industry code for second job."
label variable ptio2ocd "Occupation code for second job."
...
label variable pepar2 "Line number of first parent (always the father, if present.  Will be a female if the parents are same sex)"
label variable pepar1 "Line number of second parent (always the mother, if present.  Will be male if the parents are same sex)"
label variable pepar2typ "Type of PEPAR2"
label variable pepar1typ "Type of PEPAR1"
label variable pecohab "Line number of cohabiting partner"
label variable pxpar2 "Allocation flag"
label variable pxpar1 "Allocation flag"
label variable pxpar2typ "Allocation flag"
label variable pxpar1typ "Allocation flag"
...
label variable pecert1 "Does...have a currently active professional certification or a state or industry license?"
label variable pecert2 "Were any of …’s certifications or licenses issued by the federal, state, or local government?"
label variable pecert3 "Earlier you told me that you had a currently active professional certification or license.  Is your certification or license required for your …"
label variable pxcert1 "Allocation flag"
label variable pxcert2 "Allocation flag"
label variable pxcert3 "Allocation flag"
...
label variable peb6d21 "In what other state did you buy your LAST (pack/carton) of cigarettes?"
...
label variable peb6e4 "In the LAST 2 months, have you bought loose tobacco to roll-your-own cigarettes?"
...
label variable pec6d21 "In what other state did you buy your LAST (pack/carton) of cigarettes?"
...
label variable prc6e32a "In what OTHER state or country did you buy your LAST SINGLE OR INDIVIDUAL cigarette?"
label variable pec6e4 "In the LAST 2 months, have you bought loose tobacco to roll-your-own cigarettes?"
...
label variable ped3b "Would you say that during the past 12 months it was MORE THAN 3 TIMES that you have stopped smoking for one day or longer BECAUSE YOU WERE TRYING TO QUIT SMOKING/TRIED to QUIT smoking COMPLETELY?"
...
label variable pee1a123 "Thinking back to the (LAST TIME/time) you tried to QUIT smoking in the past 12 months: Did you use ANY of the following PRODUCTS: A NICOTINE … patch, gum, lozenge, nasal spray or inhaler?"
label variable pee1a7ab "Thinking back to the (LAST TIME/time) you tried to QUIT smoking in the past 12 months: Did you use ANY of the following PRODUCTS: A prescription pill, called Chantix, Varenicline, Zyban, Bupropion, or Wellbutrin?"
...
label variable pee1b2 "Thinking back to the (last time/time) you tried to QUIT smoking in the past 12 months. Did you use ANY of the following: One-on-one IN-PERSON counseling by a health professional?"
label variable pee1b3 "Thinking back to the (last time/time) you tried to QUIT smoking in the past 12 months. Did you use ANY of the following: A stop smoking clinic, class, or support group?"
label variable pee1b5 "Thinking back to the (last time/time) you tried to QUIT smoking in the past 12 months. Did you use ANY of the following: Internet or a web-based program or tool including smartphone apps and text messaging programs?"
label variable pee1c2c "The (last time/time) you tried to QUIT smoking in the past 12 months. Did you do ANY of the following: Try to quit by SWITCHING to electronic or E-cigarettes? You may also know them as vape-pens, e-hookah, vapes or mods."
...
label variable pee1c2e "The (last time/time) you tried to QUIT smoking in the past 12 months: Did you do ANY of the following: Try to quit by SWITCHING to nicotine pouches?"
...
label variable peh6c2 "We are still talking about Around this time 12 months ago. Thinking back to the 12 MONTHS BEFORE YOU QUIT SMOKING CIGARETTES, during that time, did you usually smoke menthol or non-menthol cigarettes?"
...
label variable peh6d123 "Now I would like to ask about HOW you went about completely quitting smoking.  When you quit smoking completely, did you use ANY of the following PRODUCTS: A NICOTINE…patch, gum, lozenge, nasal spray or inhaler?"
label variable peh6d7ab "Now I would like to ask about HOW you went about completely quitting smoking.  When you quit smoking completely, did you use ANY of the following PRODUCTS: A prescription pill, called Chantix, Varenicline, Zyban, Bupropion, or Wellbutrin?"
label variable peh6e1 "When you quit smoking completely, did you use ANY of the following: A telephone help line or quit line?"
label variable peh6e2 "When you quit smoking completely, did you use ANY of the following: One-on-one IN-PERSON counseling by a health professional?"
label variable peh6e3 "When you quit smoking completely, did you use ANY of the following: A stop smoking clinic, class, or support group?"
label variable peh6e5 "When you quit smoking completely, did you use ANY of the following: Internet or a web-based program or tool including smartphone apps and text messaging programs?"
label variable peh6fa2c "When you quit smoking completely, did you do ANY of the following, whether or not you think they were effective: Try to quit by SWITCHING to electronic or E-Cigarettes? You may also know them as vape-pens, e-hookahs, vapes or mods."
...
label variable peh6fa2e "When you quit smoking completely, did you do ANY of the following, whether or not you think they were effective: Try to quit by SWITCHING to nicotine pouches?"
...
label variable peh11d "For how long did you smoked MENTHOL cigarettes?"
...
label variable pej1a5r "(Have/Has) (you/name) EVER used a nicotine pouch EVEN ONE TIME?"
label variable pej1a6 "(Have/Has) (you/name) EVER tried a 'heated tobacco product EVEN ONE TIME?"
...
label variable pej2a5r "(Do you /Does name) NOW use nicotine pouches every day, some days or not at all?"
label variable pej2b5r "On how many of the past 30 days did you use nicotine pouches?"
label variable pej2a6 "(Do you /Does name) NOW use heated tobacco products every day, some days or not at all?"
label variable pej2b6 "On how many of the past 30 days did you use heated tobacco products?"
label variable pejb1 "During the PAST 30 days, did you use regular/large cigars?"
label variable pejb2 "During the PAST 30 days, did you use cigarillos (in Spanish use 'medium size cigars'' instead of the word 'cigarillos' here)?"
label variable pejb3 "During the PAST 30 days, did you use little filtered cigars?"
label variable ptjg "During the PAST 30 days, what BRAND of nicotine pouches did you use MOST OFTEN?"
...
label variable pejfla1a1 "During the past 30 days, when you smoked regular or large cigars, did you use menthol flavor?"
label variable pejfla1a2 "During the past 30 days, when you smoked regular or large cigars, did you use mint flavor?"
label variable ptjfla1a3 "During the past 30 days, when you smoked regular or large cigars, did you use clove, spice, or herb flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla1a4 "During the past 30 days, when you smoked regular or large cigars, did you use fruit flavor?"
label variable pejfla1a5 "During the past 30 days, when you smoked regular or large cigars, did you use alcohol drinks (such as wine or other cocktails) flavor?"
label variable pejfla1a6 "During the past 30 days, when you smoked regular or large cigars, did you use candy, dessert, or other sweets flavor?"
label variable pejfla1a8 "During the past 30 days, when you smoked regular or large cigars, did you use unflavored type?"
label variable ptjfla1a9 "During the past 30 days, when you smoked regular or large cigars, did you use some other type of flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla1b1 "During the past 30 days, when you smoked cigarillos, did you use menthol flavor?"
label variable ptjfla1b2 "During the past 30 days, when you smoked cigarillos, did you use mint flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable ptjfla1b3 "During the past 30 days, when you smoked cigarillos, did you use clove, spice, or herb flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla1b4 "During the past 30 days, when you smoked cigarillos, did you use fruit flavor?"
label variable pejfla1b5 "During the past 30 days, when you smoked cigarillos, did you use alcohol drinks (such as wine or other cocktails) flavor?"
label variable pejfla1b6 "During the past 30 days, when you smoked cigarillos, did you use candy, dessert, or other sweets flavor?"
label variable pejfla1b8 "During the past 30 days, when you smoked cigarillos, did you use unflavored type?"
label variable ptjfla1b9 "During the past 30 days, when you smoked cigarillos, did you use some other type of flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla1c1 "During the past 30 days, when you smoked little filtered cigars, did you use menthol flavor?"
label variable ptjfla1c2 "During the past 30 days, when you smoked little filtered cigars, did you use mint flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla1c3 "During the past 30 days, when you smoked little filtered cigars, did you use clove, spice, or herb flavor?"
label variable pejfla1c4 "During the past 30 days, when you smoked little filtered cigars, did you use fruit flavor?"
label variable ptjfla1c5 "During the past 30 days, when you smoked little filtered cigars, did you use alcohol drinks (such as wine or other cocktails) flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla1c6 "During the past 30 days, when you smoked little filtered cigars, did you use candy, dessert, or other sweets flavor?"
label variable pejfla1c8 "During the past 30 days, when you smoked little filtered cigars, did you use unflavored type?"
label variable ptjfla1c9 "During the past 30 days, when you smoked little filtered cigars, did you use some other type of flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla1d1 "During the past 30 days, when you smoked cigar, did you use menthol flavor?"
label variable pejfla1d2 "During the past 30 days, when you smoked cigar, did you use mint flavor?"
label variable pejfla1d3 "During the past 30 days, when you smoked cigar, did you use clove, spice, or herb flavor?"
label variable pejfla1d4 "During the past 30 days, when you smoked cigar, did you use fruit flavor?"
label variable pejfla1d5 "During the past 30 days, when you smoked cigar, did you use alcohol drinks (such as wine or other cocktails) flavor?"
label variable pejfla1d6 "During the past 30 days, when you smoked cigar, did you use candy, dessert, or other sweets flavor?"
label variable pejfla1d8 "During the past 30 days, when you smoked cigar, did you use unflavored type?"
label variable pejfla1d9 "During the past 30 days, when you smoked cigar, did you use some other type of flavor?"
label variable pejfla21 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use menthol flavor?"
label variable ptjfla22 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use mint flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable ptjfla23 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use clove, spice, or herb flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla24 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use fruit flavor?"
label variable ptjfla25 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use alcohol drinks (such as wine or other cocktails) flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable ptjfla26 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use candy, dessert, or other sweets flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla28 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use unflavored type?"
label variable ptjfla29 "During the past 30 days, when you smoked a regular pipe filled with tobacco, did you use some other type of flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla31 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use menthol flavor?"
label variable pejfla32 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use mint flavor?"
label variable pejfla33 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use clove, spice, or herb flavor?"
label variable pejfla34 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use fruit flavor?"
label variable ptjfla35 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use alcohol drinks (such as wine or other cocktails) flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla36 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use candy, dessert, or other sweets flavor?"
label variable pejfla38 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use unflavored type?"
label variable ptjfla39 "During the past 30 days, when you smoked a water/hookah pipe filled with tobacco, did you use some other type of flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla351 "During the past 30 days, when you used e-cigarettes, did you use menthol flavor?"
label variable pejfla352 "During the past 30 days, when you used e-cigarettes, did you use mint flavor?"
label variable pejfla353 "During the past 30 days, when you used e-cigarettes, did you use clove, spice, or herb flavor?"
label variable pejfla354 "During the past 30 days, when you used e-cigarettes, did you use fruit flavor?"
label variable pejfla355 "During the past 30 days, when you used e-cigarettes, did you use alcohol drinks (such as wine or other cocktails) flavor?"
label variable pejfla356 "During the past 30 days, when you used e-cigarettes, did you use candy, dessert, or other sweets flavor?"
label variable pejfla357 "During the past 30 days, when you used e-cigarettes, did you use tobacco flavor?"
label variable pejfla358 "During the past 30 days, when you used e-cigarettes, did you use unflavored type?"
label variable pejfla359 "During the past 30 days, when you used e-cigarettes, did you use some other type of flavor?"
label variable pejfla41 "During the past 30 days, when you used smokeless tobacco, did you use menthol flavor?"
label variable pejfla42 "During the past 30 days, when you used smokeless tobacco, did you use mint flavor?"
label variable pejfla43 "During the past 30 days, when you used smokeless tobacco, did you use clove, spice, or herb flavor?"
label variable pejfla44 "During the past 30 days, when you used smokeless tobacco, did you use fruit flavor?"
label variable ptjfla45 "During the past 30 days, when you used smokeless tobacco, did you use alcohol drinks (such as wine or other cocktails) flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla46 "During the past 30 days, when you used smokeless tobacco, did you use candy, dessert, or other sweets flavor?"
label variable pejfla48 "During the past 30 days, when you used smokeless tobacco, did you use unflavored type?"
label variable ptjfla49 "During the past 30 days, when you used smokeless tobacco, did you use some other type of flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla5r1 "During the past 30 days, when you used nicotine pouches, did you use menthol flavor?"
label variable pejfla5r2 "During the past 30 days, when you used nicotine pouches, did you use mint flavor?"
label variable pejfla5r3 "During the past 30 days, when you used nicotine pouches, did you use clove, spice, or herb flavor?"
label variable pejfla5r4 "During the past 30 days, when you used nicotine pouches, did you use fruit flavor?"
label variable ptjfla5r5 "During the past 30 days, when you used nicotine pouches, did you use alcohol drinks (such as wine or other cocktails) flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable ptjfla5r6 "During the past 30 days, when you used nicotine pouches, did you use candy, dessert, or other sweets flavor? (top coded – See TUS Overview/Attachment 3A)"
label variable ptjfla5r7 "During the past 30 days, when you used nicotine pouches, did you use tobacco flavored? (top coded – See TUS Overview/Attachment 3A)"
label variable pejfla5r8 "During the past 30 days, when you used nicotine pouches, did you use unflavored type?"
label variable ptjfla5r9 "During the past 30 days, when you used nicotine pouches, did you use some other type of flavor?  (top coded – See TUS Overview/Attachment 3A)"
label variable pejecigrd "Do you use e-cigarettes to help you quit smoking cigarettes?"
label variable pejecig2 "Which of the following best describes the type of e-cigarette you currently use?"
label variable pejecig3 "Do you usually buy your own (e-cigarettes/e-cigarette pods or cartridges/e-liquid)?"
label variable pejecig4r "Where do you usually buy your own (e-cigarettes/e-cigarette pods or cartridges/e-liquid)?"
label variable pejcost1 "Do you usually buy (e-cigarettes/e-cigarette pods or cartridges/bottles of e-liquid) by the box or pack, or as (single e-cigarettes/single e-cigarette pods or cartridges/a single bottle of e-liquid)?"
label variable ptjcost2 "What price did you pay for the LAST BOX OR PACK of (e-cigarettes/e-cigarette pods or cartridges/bottles of e-liquid) you bought? Please report the cost after using discounts or coupons."
label variable pejcost3 "How many (e-cigarettes/e-cigarette pods or cartridges/bottles of e-liquid) came in the LAST BOX OR PACK you bought?"
label variable ptjcost4 "What price did you pay for the LAST (e-cigarette/e-cigarette pod or cartridge/bottle of e-liquid) you bought? Please report the cost after using discounts or coupons."
label variable pejcost5 "How many MILLILITERS of liquid were in a SINGLE bottle you LAST bought?"
...
label variable pejd14 "About how long has it been since you COMPLETELY quit using smokeless tobacco? (number)"
label variable pejd24 "About how long has it been since you COMPLETELY quit using smokeless tobacco? (unit)"
...
label variable pejfecgrd "Did you use e-cigarettes to help you quit smoking cigarettes? "
label variable pejfecg2 "Which of the following best describes the type of e-cigarette you used to use?  If you used more than one type, please think of the one you used most often."
...
label variable pej7cint "The LAST TIME you tried to QUIT smoking CIGARS in the past 12 months: Did you:"
label variable prj7 "The LAST TIME you tried to QUIT smoking CIGARS in the past 12 months: Did you: Try to quit by SWITCHING to smokeless tobacco, electronic or E-cigarettes or nicotine pouches?"
label variable pej7altin "When you quit smoking CIGARS completely, did you do ANY of the following, whether or not you think they were effective:"
label variable prj7alt "When you quit smoking CIGARS completely, did you do ANY of the following, whether or not you think they were effective: Try to quit by SWITCHING to smokeless tobacco, electronic or E-cigarettes or nicotine pouches?"
...
label variable pek3c "During the PAST TWO WEEKS, has anyone smoked in the area in which you work?"
label variable pek3b1 "Which of these best describes the vaping or e-cigarette policy at your place of work for INDOOR PUBLIC OR COMMON AREAS AND INDOOR WORK AREAS?"
label variable pek3c1 "During the PAST TWO WEEKS, has anyone vaped or used e-cigarettes in the area in which you work?"
label variable pek4 "Which statement best describes the rules about smoking INSIDE YOUR HOME?"
label variable pek4a "Which statement best describes the rules about vaping or using e-cigarettes INSIDE YOUR HOME?"
...
label variable peelgflg "Eligibility Flag"